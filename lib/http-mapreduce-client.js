...
var HttpMapReduceClient = function HttpMapReduceClient(options) {
...
HttpMapReduceClient.prototype._run = function(job, options, callback) {
  ...
  var meta = new Meta(this._client._defaults, options, { resource: 'mapred', method: 'post', callback: callback }),
