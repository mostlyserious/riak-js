 ...
 * @api public
 */
var HttpRequest = function HttpRequest(protocol, client, meta) {
  this.meta = meta;
  this.client = client;
...
HttpRequest.prototype.execute = function() {
  ...
  var options = meta;
  if (this.protocol === require('https')) {
    options = {
      host: meta.host,
      port: meta.port,
      method: meta.method,
    ...
    if ('rejectUnauthorized' in meta) {
      options['rejectUnauthorized'] = meta.rejectUnauthorized;
    }
  }

  var request = httpClient.request(options, function(err, response) {
