(function() {
  ...
  HttpClient.prototype.head = function(bucket, key) {
    var meta, options;
    var _a = arguments.length, _b = _a >= 4, callback = arguments[_b ? _a - 1 : 2];
    options = __slice.call(arguments, 2, _a - 1);
    options = options[0];
  ...
  HttpClient.prototype.getAll = function(bucket) {
    var limiter, map, mapfunc, options;
    var _a = arguments.length, _b = _a >= 3, callback = arguments[_b ? _a - 1 : 1];
    options = __slice.call(arguments, 1, _a - 1);
    options = options[0] || {};
  ...
  HttpClient.prototype.count = function(bucket) {
    ...
    options = __slice.call(arguments, 1, _a - 1);
    options || (options = {});
    return this.map('Riak.mapValues').reduce(function(v) {
      return [v.length];
    }).run(bucket, callback);
  };
  HttpClient.prototype.walk = function(bucket, key, spec) {
    var linkPhases, options;
    var _a = arguments.length, _b = _a >= 5, callback = arguments[_b ? _a - 1 : 3];
    options = __slice.call(arguments, 3, _a - 1);
    options = options[0];
    ...
    }).map('Riak.mapValuesJson').run(key ? [[bucket, key]] : bucket, options);
  };
  HttpClient.prototype.save = function(bucket, key, data) {
    var meta, options, verb;
    var _a = arguments.length, _b = _a >= 5, callback = arguments[_b ? _a - 1 : 3];
    options = __slice.call(arguments, 3, _a - 1);
    options = options[0];
    data || (data = {});
