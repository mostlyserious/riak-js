...
Meta.prototype.decode = function(data) {
  ...
  // TODO check where does responseEncoding belong (meta or http meta)
  if (this.responseEncoding == 'binary' || this._isBinary(this.contentType)) {
    return new Buffer(data, 'binary');
  } else {
    switch (this.contentType) {
      case 'application/json': return JSON.parse(data);
      default: return data;
    }
  }
