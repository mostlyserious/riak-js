...
Riak.prototype.walk2 = function(bucket, key, spec, options) {
  ...
  return this.mapReduce([[bucket, key]], query, options);
}
...
// Riak.prototype.mapReduce = function(inputs, query, options) {
//   options = this.ensure(options);
